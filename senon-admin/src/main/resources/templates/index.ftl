...
<form action="${ctx.contextPath }/dependency_map.jsp" target="_blank" id="dependency_map_form" method="post">
    <input type="hidden" name="id" value="" id="dependency_view_job_id">
</form>
<#include "/modules/footer.ftl"/>
<script type="text/javascript" src="${ctx.contextPath }/js/jquery.ztree.core-3.5.js"></script>
<script type="text/javascript" src="${ctx.contextPath }/js/jquery.ztree.excheck-3.5.min.js"></script>
<script type="text/javascript" src="${ctx.contextPath }/js/jquery.ztree.exedit-3.5.min.js"></script>
<script type="text/javascript" src="${ctx.contextPath }/codemirror/lib/codemirror.js"></script>
<script type="text/javascript" src="${ctx.contextPath }/codemirror/mode/sql/sql.js"></script>
<script type="text/javascript" src="${ctx.contextPath }/js/JobTree.js"></script>
